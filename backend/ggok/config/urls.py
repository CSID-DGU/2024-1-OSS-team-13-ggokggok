...
from community.api import PostViewSet, CommentViewSet
...
from place.views import base_views
...
urlpatterns = [
    ...
    path('api/', include(place_comment_router.urls)),    path('place/', include('place.urls')),
